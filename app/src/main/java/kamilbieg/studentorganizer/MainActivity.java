...
public class MainActivity extends AppCompatActivity
    ...
    @BindView(R.id.lay_tab) TabLayout tabLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SetFragment(R.id.fragment_container, Fragments.NotesFragment);
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                switch (tab.getPosition()){
                    ...
                    case 1:{
                        SetFragment(R.id.fragment_container, Fragments.StudyFragment);
                        break;
                    }
                    case 2:{
                        SetFragment(R.id.fragment_container, Fragments.ArchFragment);
                        break;
                    }
                }
            }
    ...
    private void SetFragment(int idContainer, Fragments fragment){

        switch (fragment){
            case NotesFragment:{
                NotesFragment notesFragment = new NotesFragment();
                FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
                transaction.replace(idContainer, notesFragment);
                transaction.commit();
                break;
            }
            case StudyFragment:{
            ...
            case ArchFragment:{
                ...
                FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
                transaction.replace(R.id.fragment_container, archFragment);
                transaction.commit();
                break;
            }
        }
